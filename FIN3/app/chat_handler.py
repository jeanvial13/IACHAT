...
def build_portfolio_html(projects):
    ...
    for p in projects:
        ...
        html += f"""
        <div style="display: grid; grid-template-columns: 200px 1fr; gap: 20px; padding: 15px 0; border-top: 1px solid #222;">
            <!-- Left Col: Meta -->
            <div>
                <div style="color: {priority_color}; font-size: 10px; font-family: 'Roboto Mono', monospace; margin-bottom: 4px;">
                    {p_id} // P{priority}
                </div>
                <div style="color: #fff; font-size: 14px; font-weight: 500; margin-bottom: 8px; line-height: 1.3;">
                    {name}
                </div>
                ...
                <!-- Additional Details -->
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 5px; font-family: 'Roboto Mono', monospace; font-size: 9px; color: #555;">
                    <div>
            ...
            <div>
                <div style="display: flex; gap: 15px; margin-bottom: 10px; font-family: 'Roboto Mono', monospace; font-size: 10px; color: #888;">
                ...
                <div style="font-family: 'Roboto Mono', monospace; font-size: 11px; color: #aaa; line-height: 1.5; background: #111; padding: 10px; border-left: 2px solid {priority_color};">
                    {ai_comment}
                </div>
            </div>
        </div>
