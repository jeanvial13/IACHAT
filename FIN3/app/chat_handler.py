...
def build_portfolio_html(projects):
    ...
    <div style="font-family: 'Rajdhani', sans-serif; color: #e0e0e0; max-width: 1200px; margin: 0 auto;">
        <!-- HEADER -->
        <div style="border-bottom: 1px solid #333; padding-bottom: 10px; margin-bottom: 20px; display: flex; justify-content: space-between; align-items: flex-end;">
            <div>
                <h1 style="color: #fff; font-size: 20px; margin: 0; font-weight: 600; letter-spacing: 1px;">
                    ANDRES VILLANUEVA <span style="color: #00f3ff;">//</span> PROJECT STATUS
                </h1>
            </div>
            <div style="font-family: 'Roboto Mono', monospace; font-size: 10px; color: #666;">
                GENERATED: {now_str}
            </div>
        </div>
        ...
        <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 10px; margin-bottom: 30px;">
            <div style="padding: 5px 0;">
                <div style="font-size: 10px; color: #666; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 2px;">Active Projects</div>
                <div style="font-size: 24px; color: #fff; font-weight: 500;">{len(projects)}</div>
            </div>
            <div style="padding: 5px 0;">
                <div style="font-size: 10px; color: #666; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 2px;">Critical (P1)</div>
                <div style="font-size: 24px; color: #ff2a2a; font-weight: 500;">
                    {len([p for p in projects if str(p.get('priority')) == '1'])}
                </div>
            </div>
            <div style="padding: 5px 0;">
                <div style="font-size: 10px; color: #666; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 2px;">SLA Breached</div>
                <div style="font-size: 24px; color: #fcee0a; font-weight: 500;">
                    {len([p for p in projects if p.get('sla_breached')])}
                </div>
            </div>
            <div style="padding: 5px 0;">
                <div style="font-size: 10px; color: #666; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 2px;">Completed</div>
                <div style="font-size: 24px; color: #00f3ff; font-weight: 500;">
        ...
        <div style="margin-bottom: 10px;">
            <h2 style="font-size: 12px; color: #888; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 10px; font-weight: 400;">
                Active Workstreams
            </h2>
    """
    ...
    for p in projects:
        ...
        html += f"""
        <div style="display: grid; grid-template-columns: 200px 1fr; gap: 15px; padding: 10px 0; border-top: 1px solid #222;">
            <!-- Left Col: Meta -->
            <div>
                <div style="color: {priority_color}; font-size: 10px; font-family: 'Roboto Mono', monospace; margin-bottom: 2px;">
                    {p_id} // P{priority}
                </div>
                <div style="color: #fff; font-size: 13px; font-weight: 500; margin-bottom: 5px; line-height: 1.2;">
                    {name}
                </div>
                ...
                <!-- Additional Details -->
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 2px; font-family: 'Roboto Mono', monospace; font-size: 9px; color: #555;">
                    <div>
                        <div style="color: #444;">SPONSOR</div>
                        <div style="color: #888;">{sponsor}</div>
                    </div>
                    <div>
                        <div style="color: #444;">REQUESTER</div>
                        <div style="color: #888;">{requester}</div>
                    </div>
                    <div>
                        <div style="color: #444;">COST CENTER</div>
                        <div style="color: #888;">{cost_center}</div>
                    </div>
                    <div>
                        <div style="color: #444;">BA OWNER</div>
            ...
            <div>
                <div style="display: flex; gap: 10px; margin-bottom: 5px; font-family: 'Roboto Mono', monospace; font-size: 9px; color: #888;">
                ...
                <div style="font-family: 'Roboto Mono', monospace; font-size: 10px; color: #aaa; line-height: 1.4; background: #111; padding: 8px; border-left: 2px solid {priority_color};">
                    {ai_comment}
                </div>
            </div>
        </div>
