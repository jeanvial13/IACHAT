...
def generate_charts(dems):
    ...
    ax1.tick_params(axis='x', colors='#333333') # Dark text
    ax1.tick_params(axis='y', colors='#333333') # Dark text
    ...
    ax2.set_yticklabels(keys_sla, color="#333333", fontweight='bold') # Bold Dark text
    ax2.invert_yaxis()
    
    for i, v in enumerate(vals_sla):
        ax2.text(v + 0.1, i, str(v), color='#333333', va='center', fontweight='bold') # Bold Dark text

    ax2.set_title("SLA Status", color="#333333", pad=10, fontweight='bold') # Bold Dark text
    ax2.spines['top'].set_visible(False)
    ax2.spines['right'].set_visible(False)
    ax2.spines['bottom'].set_visible(False)
    ax2.spines['left'].set_visible(False)
    ax2.tick_params(axis='x', colors='#333333') # Dark text
    ax2.tick_params(axis='y', colors='#333333') # Dark text
    ...
    colors_status = ['#00f3ff', '#bd00ff', '#fcee0a', '#ff2a2a', '#00ff9f', '#333333']
    ...
    ax3.set_yticklabels(keys_stat, color="#333333", fontsize=8, fontweight='bold') # Bold Dark text
    ax3.invert_yaxis()
    ...
    for i, v in enumerate(vals_stat):
        ax3.text(v + 0.1, i, str(v), color='#333333', va='center', fontweight='bold') # Bold Dark text

    ax3.set_title("Project Status", color="#333333", pad=10, fontweight='bold') # Bold Dark text
    ax3.spines['top'].set_visible(False)
    ax3.spines['right'].set_visible(False)
    ax3.spines['bottom'].set_visible(False)
    ax3.spines['left'].set_visible(False)
    ax3.tick_params(axis='x', colors='#333333', labelsize=8) # Dark text
    ax3.tick_params(axis='y', colors='#333333') # Dark text
