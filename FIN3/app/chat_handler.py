...
def generate_charts(dems):
    ...
    ax1.set_yticklabels(labels, color="#333333", fontweight='bold') # Bold Dark text
    ax1.invert_yaxis()
    
    for i, v in enumerate(values):
        ax1.text(v + 0.1, i, str(v), color='#333333', va='center', fontweight='bold') # Bold Dark text

    ax1.set_title("Priority Distribution", color="#333333", pad=10, fontweight='bold') # Bold Dark text
    ax1.spines['top'].set_visible(False)
    ax1.spines['right'].set_visible(False)
    ax1.spines['bottom'].set_visible(False)
    ax1.spines['left'].set_visible(False)
    ax1.tick_params(axis='x', colors='#e0e0e0') # Light text
    ax1.tick_params(axis='y', colors='#e0e0e0') # Light text
    ...
    ax2.set_yticklabels(keys_sla, color="#e0e0e0", fontweight='bold') # Bold Light text
    ax2.invert_yaxis()
    
    for i, v in enumerate(vals_sla):
        ax2.text(v + 0.1, i, str(v), color='#e0e0e0', va='center', fontweight='bold') # Bold Light text

    ax2.set_title("SLA Status", color="#e0e0e0", pad=10, fontweight='bold') # Bold Light text
    ax2.spines['top'].set_visible(False)
    ax2.spines['right'].set_visible(False)
    ax2.spines['bottom'].set_visible(False)
    ax2.spines['left'].set_visible(False)
    ax2.tick_params(axis='x', colors='#e0e0e0') # Light text
    ax2.tick_params(axis='y', colors='#e0e0e0') # Light text
    ...
    colors_status = ['#00f3ff', '#bd00ff', '#fcee0a', '#ff2a2a', '#00ff9f', '#e0e0e0']
    ...
    ax3.set_yticklabels(keys_stat, color="#e0e0e0", fontsize=8, fontweight='bold') # Bold Light text
    ax3.invert_yaxis()
    ...
    for i, v in enumerate(vals_stat):
        ax3.text(v + 0.1, i, str(v), color='#e0e0e0', va='center', fontweight='bold') # Bold Light text

    ax3.set_title("Project Status", color="#e0e0e0", pad=10, fontweight='bold') # Bold Light text
    ax3.spines['top'].set_visible(False)
    ax3.spines['right'].set_visible(False)
    ax3.spines['bottom'].set_visible(False)
    ax3.spines['left'].set_visible(False)
    ax3.tick_params(axis='x', colors='#e0e0e0', labelsize=8) # Light text
    ax3.tick_params(axis='y', colors='#e0e0e0') # Light text
...
def dem_download(fmt):
    ...
    if fmt == "pdf":
        ...
        # 1. Header
        story.append(Paragraph("DEM Portfolio Report", title_style))
