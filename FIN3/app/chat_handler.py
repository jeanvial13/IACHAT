...
def generate_charts(dems):
    ...
    ax3.pie(status_counts.values(), labels=status_counts.keys(), autopct='%1.1f%%', startangle=140, colors=colors[:len(status_counts)])
    ax3.axis('equal')
...
def dem_download(fmt):
    ...
    if fmt == "pdf":
        ...
        story.append(Paragraph("Projects Dashboard", title_style))
        ...
        for d in dems:
            ...
            table_data.append([
                ...
                Paragraph(last_note, styles["Normal"])
            ])
