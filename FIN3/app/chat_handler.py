...
def build_portfolio_html(projects):
    ...
    <div style="font-family: 'Roboto Mono', monospace; color: #e0e0e0; background-color: #0d0d0d; padding: 20px; border: 1px solid #333; border-radius: 5px; max-width: 1000px; margin: 0 auto;">
        ...
        <div style="margin-bottom: 30px;">
            <div style="color: #fff; margin-bottom: 10px; font-weight: bold;">1. Projects Resume — Executive Overview</div>
            <div style="font-size: 13px; color: #ccc; line-height: 1.6;">
                <div>Key portfolio metrics for active DEM projects:</div>
                <div style="padding-left: 15px;">• Total active DEMs: <span style="color: #fff;">{total}</span></div>
                <div style="padding-left: 15px;">• Priority distribution:</div>
                <div style="padding-left: 30px;">- P1 (Critical): <span style="color: #ff2a2a;">{p1}</span></div>
                <div style="padding-left: 30px;">- P2 (High): <span style="color: #ffaa00;">{p2}</span></div>
                <div style="padding-left: 30px;">- P3 (Medium): <span style="color: #00f3ff;">{p3}</span></div>
                <div style="padding-left: 30px;">- P4 (Low): <span style="color: #888;">{p4}</span></div>
                <div style="padding-left: 15px;">• SLA window (last 5 days): <span style="color: #00f3ff;">OK={sla_ok}</span> | <span style="color: #ff2a2a;">Breached={sla_breached}</span></div>
                <div style="padding-left: 15px;">• Most common DEM Status: {status_summary}</div>
            </div>
        </div>
