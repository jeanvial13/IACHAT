...
def build_portfolio_html(projects):
    ...
    for p in projects:
        ...
        html += f"""
        <div style="display: grid; grid-template-columns: 200px 1fr; gap: 40px; padding: 25px 0; border-top: 1px solid #222;">
            <!-- Left Col: Meta -->
            <div>
...
def generate_charts(dems):
    ...
    ax1.set_yticklabels(labels, color="#333333") # Dark text
    ax1.invert_yaxis()
    
    for i, v in enumerate(values):
        ax1.text(v + 0.1, i, str(v), color='#333333', va='center', fontweight='bold') # Dark text

    ax1.set_title("Priority Distribution", color="#333333", pad=10) # Dark text
    ...
    ax2.set_yticklabels(keys_sla, color="#333333") # Dark text
    ax2.invert_yaxis()
    
    for i, v in enumerate(vals_sla):
        ax2.text(v + 0.1, i, str(v), color='#333333', va='center', fontweight='bold') # Dark text

    ax2.set_title("SLA Status", color="#333333", pad=10) # Dark text
    ...
    ax3.set_yticklabels(keys_stat, color="#333333", fontsize=8) # Dark text
    ax3.invert_yaxis()
    
    for i, v in enumerate(vals_stat):
        ax3.text(v + 0.1, i, str(v), color='#333333', va='center', fontweight='bold') # Dark text

    ax3.set_title("Project Status", color="#333333", pad=10) # Dark text
    ax3.spines['top'].set_visible(False)
    ax3.spines['right'].set_visible(False)
    ax3.spines['bottom'].set_visible(False)
    ax3.spines['left'].set_visible(False)
    ax3.tick_params(axis='x', colors='#333333') # Dark text
